...
public class UserOfSorts {
  public static void main(String[] commandLine) {
    ...
    ArrayList<String> unsorted = new ArrayList<String>(
        /*
         * Java's Arrays.asList provides a perspicuous way to build a Collection from
         * literals, suitable for constructing an ArrayList
         */
        Arrays.asList(
            ...
            /*
             * more data for the end, so subsequent tests process a larger sorted region
             */
            , "F", "J", "L", "N"
            ...
            /*
             * buffering data, merely to keep the preceding data from having the special
             * property of being last in the input list.
             */
            , "Z"));

    ArrayList<String> unsorted2 = new ArrayList<>(unsorted);

    // insertion sort
    oneTest("insertion sort ", new InsertionSorter(unsorted));
    oneTest("insertion sort ", new SelectionSorter(unsorted2));
  }

  /**
   * Run one test
   */
  private static void oneTest(String description, Sorter sorter) {
